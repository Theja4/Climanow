...
<div class="search" >
<form autocomplete="off" action="weather" method="get">
  <div class="autocomplete" >
    <input id="myInput" type="text" name="city" placeholder="Enter city">
   <input type="submit">
  </div>
 
</form>
<div style="padding-top:20px;"><span class="info" >ex. Delhi, Hyderabad, Bengaluru, etc.</span></div>
